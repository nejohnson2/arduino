...
const int left = 320;         // threshold for the joystick to go left   
const int right = 370;        // threshold for the joystick to go right
...
void loop()
{
  ...
  if (buttonPushed) {
    // if the client's connected, disconnect:128,
    if (client.connected()) {
